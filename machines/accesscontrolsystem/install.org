#+TITLE: Installing NixOS on accesscontrolsystem
#+AUTHOR: Masood Ahmed
#+OPTIONS: toc:nil num:nil

This document describes the *manual, repeatable procedure* for installing
NixOS on the =accesscontrolsystem= OCI VM using =netboot.xyz=, UEFI shell
...
#+begin_src bash
ssh ubuntu@accesscontrolsystem.oci.mantannest.com
sudo su - root
#+end_src
...
#+begin_src bash
ssh-keygen -R accesscontrolsystem.oci.mantannest.com
ssh nixos@accesscontrolsystem.oci.mantannest.com
#+end_src
...
nix --experimental-features "nix-command flakes" \
  ...
  --flake "github:masood09/nix#accesscontrolsystem"
#+end_src
...
sudo nix build --refresh \
  github:masood09/nix#nixosConfigurations.accesscontrolsystem.config.system.build.toplevel
#+end_src
