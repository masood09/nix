#+TITLE: Installing NixOS on commrelay
#+AUTHOR: Masood Ahmed
#+OPTIONS: toc:nil num:nil

This document describes the *manual, repeatable procedure* for installing
NixOS on the =commrelay= OCI VM using =netboot.xyz=, UEFI shell boot,
and =disko= with a pre-built NixOS system closure.
...
#+begin_src bash
ssh ubuntu@commrelay.oci.mantannest.com
sudo su - root
#+end_src
...
#+begin_src bash
ssh-keygen -R commrelay.oci.mantannest.com
ssh nixos@commrelay.oci.mantannest.com
#+end_src
...
nix --experimental-features "nix-command flakes" \
  ...
  --flake "github:masood09/nix#commrelay"
#+end_src
...
sudo nix build --refresh \
  github:masood09/nix#nixosConfigurations.commrelay.config.system.build.toplevel
#+end_src
...
nix --extra-experimental-features 'nix-command flakes' \
  ...
  --from 'ssh-ng://masoodahmed@watchfulsystem.oci.mantannest.com:22222' \
  --to 'local?root=/mnt' \
  <STORE_PATH>
#+end_src
