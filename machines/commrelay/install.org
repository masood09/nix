...
nix --extra-experimental-features 'nix-command flakes' \
  ...
  --to 'local?root=/mnt' \
  /nix/store/95sknzqxlvbpdi08kxfbrifijdr26r8a-nixos-system-commrelay-25.11.20260203.e576e3c
#+end_src
...
NIX_REMOTE='local?root=/mnt' \
  ...
  --no-root-passwd \
  --root /mnt \
  --system /nix/store/95sknzqxlvbpdi08kxfbrifijdr26r8a-nixos-system-commrelay-25.11.20260203.e576e3c
#+end_src
