      ...
      oci-containers = {
        containers = {
          "opencloud-opencloud" = {
            ...
            image = "docker.io/opencloudeu/opencloud:4.0.7";
            ...
            environment = {
              ...
              "OC_LOG_PRETTY" = "false";
              "OC_OIDC_ISSUER" = "https://${cfg.oidc.idpDomain}/application/o/opencloud/";
          ...
          "opencloud-collabora" = {
            ...
            image = "docker.io/collabora/code:25.04.10.3.1";
